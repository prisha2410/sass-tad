#!/usr/bin/env python3
"""Ablation: no stylometric features (DeBERTa CLS only)."""
...
def forward_doc(model, cls_block, style_block):
    ...
    for j in range(cls_block.shape[0]):
        ...
        style = torch.zeros(1, 193).to(DEVICE)
...
def train(args):
    ...
    print(f"Ablation: NO STYLOMETRIC | Device: {DEVICE}")
...
if __name__ == "__main__":
    ...
    p.add_argument("--out-dir", default="checkpoints/ablation_no_stylometric")
